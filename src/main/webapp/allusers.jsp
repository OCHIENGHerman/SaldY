...
<head>
    <meta charset="UTF-8">
    <title>All Users | Employee Salary Management System</title>
        ...
        <div class="top-bar">
            <div class="container-fluid clearfix">
                ...
                <div class="right-content float-right">
                    <ul>
                        <a style="color:white" href="topnotch" target="_blank">Made By Team SALDY</a>
                    </ul>
                </div><!-- /.left-content -->
            </div><!-- /.container-fluid -->
        </div><!-- /.top-bar -->
...
<section class="hidden-sidebar side-navigation">
    ...
    <div class="sidebar-content">
        ...
        <p class="contact-info"><i class="fa fa-phone"></i>0743851498</p><!-- /.contact-info -->
